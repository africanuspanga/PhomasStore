...
class EcountApiService {
  ...
  async submitSaleOrder(order: Order, userProfile?: any): Promise<{ docNo: string, ioDate: string }> {
    try {
      ...
      // 🚀 CORRECTED SALES ORDER API - Use the correct SaleList structure (not BulkDatas)
      const saleOrderPayload = salesPayload; // Use the correct payload structure defined above
